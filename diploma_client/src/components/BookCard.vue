...
<template>
  <div class="p-4 bg-background-two rounded-xl">
    <img :src="logo" class="w-full h-48 object-cover mb-4 rounded-xl"  alt=""/>
    <h3 class="text-2xl font-bold text-font-colored font-main mb-2">{{ title }}</h3>
    <p class="text-font-main text-lg font-main mb-4">{{ author }}</p>
